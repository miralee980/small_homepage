...
const FAQ = () => {
	...
	const [orderQuestion, setOrderQuestion] = useState([
		...
		},
		{
			...
			answer: `<p style="${answer_txt}">- 머니포트의 투자 주문은 실시간 주문이 아닌 예약 주문으로, 영업일 8:00 ~ 21:00 시간 내에 주문된 내역은 해외거래소 개장 시점에 한번에 전송됩니다.</p>
		...
		<p style="${answer_txt}">- 체결 후 남은 금액은 자동으로 위탁 계좌로 입금됩니다.</p>`
		},
		{
		...
		<p style="${answer_txt}">- 주문 실패 시 모든 금액은 위탁 계좌로 반환됩니다.</p>`
		},
		{
