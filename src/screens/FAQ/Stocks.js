...
const Stocks = () => {
	...
	useEffect(() => {
		setSelNum(1);
			if(selFaqList === 'all'){
				const test = investQuestion.concat(accountQuestion).concat(orderQuestion).concat(moneypotQuestion);
	...
	return (
		<div>
			...
			<div className="faq_box">
				<QuestionList questionList={questionList} selNum={selNum} DEFINE_LIST_NUM = {DEFINE_LIST_NUM}/>
			</div>
			<PageNum
				totalNum={totalNum}
				selNum={selNum}
